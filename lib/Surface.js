...
var Surface = React.createClass({
  ...
  handleTouchStart: function (e) {
    ...
    var swipeTarget = swipeLeftTarget || swipeRightTarget;
    var touch;
  ...
  handleTouchEnd: function (e) {
    ...
    for (var i=0, len=e.changedTouches.length; i < len; i++) {
      ...
      if (swipeEvent && this._swipeTarget && this._swipeTarget[swipeHandle]){
        this._swipeTarget[swipeHandle](e);
        this._swipeTarget = undefined;
      }
