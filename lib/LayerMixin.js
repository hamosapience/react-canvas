...
var LayerMixin = {
  ...
  applyLayerProps: function (prevProps, props) {
    ...
    layer.display = style.display;

    layer.flipper = props.flipper;
    layer.isFlipperFront = props.isFlipperFront;
    layer.isFlipperBack = props.isFlipperBack;
    layer.flipperTransition = props.flipperTransition;
    layer.flipperMode = props.flipperMode;
    layer.inTransition = (props.flipperMode === "front.transition" || props.flipperMode === "back.transition");
    layer.modeSetter = props.modeSetter;
